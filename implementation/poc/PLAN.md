...
Дата: 2026-09-03. Статус: PoC реализован 2026-09-04 по [Spec Kit feature](../../specs/001-review-data-spec-poc/spec.md); экспертная оценка не проведена.
...
Этот план фиксирует выбранную экспериментальную конфигурацию. Продуктовый таймлайн, гипотезы и свидетельства ведутся отдельно в продуктовом репозитории.

### Выбранный состав

Нумерация ниже сохранена для трассируемости исходного эксперимента; актуальный реестр гипотез находится в продуктовом репозитории.
...
`implementation/poc/review-data-spec/` содержит [переносимый навык](review-data-spec/SKILL.md), CLI и синтетические тесты. Продуктовые знания, клиентские профили, снимки и протоколы хранятся в продуктовом репозитории; в переносимую папку навыка они не включаются.

Технические критерии описаны в контрольных точках. План экспертной оценки, численные пороги, выборка, сроки и ответственные ведутся в продуктовом репозитории.

Известные клиентские примеры после использования при настройке не являются независимым контрольным набором. Работоспособность PoC не подтверждает экономию, регулярное использование, спрос или переносимость на другие компании.
