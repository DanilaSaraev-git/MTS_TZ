...
Дата: 2026-09-03. Статус: план proof of concept; реализация навыка ещё не начата. Основание: обсуждение и поручения пользователя [S-20](../../product-knowledge/sources.md), решение [D-10](../../product-knowledge/decisions.md).
...
`implementation/poc/` содержит план и будущую общую реализацию PoC. Общие продуктовые знания остаются в [knowledge](../../README.md#общая-база). Исходники, профили, результаты и протоколы client хранятся внутри [client](../../client-materials/README.md); в переносимую папку навыка они не включаются. Универсальные тестовые примеры должны быть синтетическими.
