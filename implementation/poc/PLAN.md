...
Дата: 2026-09-03. Статус: PoC реализован 2026-09-04 по [Spec Kit feature](../../specs/001-review-data-spec-poc/spec.md); экспертная оценка не проведена. Основание: обсуждение и поручения пользователя [S-20 и S-25](../../knowledge/sources.md), решения [D-10 и D-17](../../knowledge/decisions.md).
...
`implementation/poc/review-data-spec/` содержит [переносимый навык](review-data-spec/SKILL.md), CLI и синтетические тесты. Общие продуктовые знания остаются в [knowledge](../../README.md#общая-база). Профиль, снимок и [протокол MTS](../../MTS/experiments/poc-review-data-spec/README.md) хранятся внутри `MTS/`; в переносимую папку навыка они не включаются.
