...
Дата: 2026-09-04. Статус: архитектурный baseline для параллельной разработки; реализация целевого среза ещё не начата. Основание: поручения пользователя [S-26 и S-28](../knowledge/sources.md), решения [D-18 и D-19](../knowledge/decisions.md), [ADR-0001](../docs/adr/0001-contract-first-modular-monolith.md).
