...
6. Клиентские материалы MTS не копируются в web fixtures или общие contract tests. Для них используются синтетические данные.
...
- Старый PoC и сохранённый прогон MTS остаются воспроизводимыми.
