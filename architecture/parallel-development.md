...
6. Клиентские материалы client не копируются в web fixtures или общие contract tests. Для них используются синтетические данные.
...
- Старый PoC и сохранённый прогон client остаются воспроизводимыми.
