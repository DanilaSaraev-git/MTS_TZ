...
Состояние на 2026-09-05: собраны исходные материалы, рабочие гипотезы и порядок их проверки. Реализованы технический PoC переносимого навыка ревью и локальный restart-safe backend MVP по Spec Kit feature 003; проведён настроечный агентный прогон на известном примере MTS. Техническая готовность MVP не подтверждает качество замечаний или ценность продукта: экспертная оценка, независимый контроль, отдельные проблемные интервью, измерение эффекта и MTS pilot ещё не проводились.
