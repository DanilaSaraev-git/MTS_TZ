...
| [Confluence: реализуемость и аналоги](knowledge/confluence-app-assessment.md) | Возможности Forge, Cloud/Data Center, AI и inline-комментариев; ближайшие конкуренты и границы гипотезы канала |
| [Аналоги и альтернативы](knowledge/analogs.md) | Текущие способы решения задачи в MTS и непроверенные кандидаты из командных набросков |
