...
- [ ] T013 [P] [SHARED] Зафиксировать один synthetic tracer-bullet dataset без MTS-материалов в `tests/fixtures/synthetic-review/`
...
- [ ] T059 [P] [SHARED] Добавить dependency/image vulnerability scan и проверку отсутствия MTS/client data в public fixtures в CI
...
- Self-hosted restart сохраняет synthetic flow; секреты и MTS data отсутствуют в public DTO, fixtures и logs.
