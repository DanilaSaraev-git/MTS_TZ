...
Feature 003 реализует первый локальный backend-срез Review Platform. [Feature 002](../002-target-review-platform/spec.md) и публичный [HTTP v1](../../contracts/review-platform/v1/README.md) остаются неизменяемым baseline. Реализация не подтверждает качество AI-замечаний, продуктовый эффект, коммерческий статус или результаты пилота MTS.
...
- MTS/client materials в common fixtures, packages или images.
