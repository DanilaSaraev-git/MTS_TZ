...
- [X] T028 Обновить статус feature 003 и корневой карты: технический локальный MVP реализован и проверен, продуктовые исследования и MTS pilot не заявлены завершёнными, в `specs/003-backend-implementation/spec.md` и `README.md`
