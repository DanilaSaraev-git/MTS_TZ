...
- [x] Web и client-materials/client materials явно исключены из implementation diff.
...
- [x] Release gate физически собирает и тестирует public packages из source export без каталога `client-materials/`.
