...
- [X] T013 [US3] Завершить обработку профилей/приоритетов в implementation/poc/review-data-spec/scripts/review_data_spec/prepare.py и render.py; сохранить черновой MTS/experiments/poc-review-data-spec/profile.json.
...
- [X] T017 [US4] Провести агентное ревью PDF, визуально сверить проблемные страницы, сохранить отчёт и протокол в MTS/experiments/poc-review-data-spec/<run-id>/.

## Phase 7: Polish

- [X] T018 Обновить карту README.md, MTS/README.md, implementation/poc/PLAN.md, knowledge/decisions.md, sources.md и roadmap.md по фактическому результату.
